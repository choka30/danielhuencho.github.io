---
name: test
description: Execute test suite with specified scope (unit, module, integration, all, or affected). Reports results and coverage. Use to verify code changes. Can auto-trigger during task execution or when verification is needed.
---
