---
name: push
description: Push committed changes to remote repository. Runs pre-push validation including tests and brain sync check. Use after commits are ready for remote.
