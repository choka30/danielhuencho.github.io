---
name: session-start
description: Initialize a new work session. Creates brain backup, validates environment, and prepares for planning. Use at the beginning of any development session.
