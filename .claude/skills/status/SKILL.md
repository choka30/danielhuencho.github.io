---
name: status
description: Show comprehensive project status overview including git state, content progress, build health, and brain sync status. Read-only operation. Use anytime to understand current state.
---
